...
final class SettingsStore: ObservableObject {
    ...
    private(set) var launchAtStartupStatusMessage =
        "FreeFlow reflects the actual macOS login item state. Unsigned or development builds may fail to enable this."
    ...
    /// Show the main window when macOS launches FreeFlow at login (default: ON, matching
    ...
    enum TranscriptionStartSound: String, CaseIterable, Identifiable, Codable {
        ...
        var displayName: String {
            ...
            case .fluidSfx0: return "FreeFlow SFX 0"
            case .fluidSfx1: return "FreeFlow SFX 1"
            case .fluidSfx2: return "FreeFlow SFX 2"
            case .fluidSfx3: return "FreeFlow SFX 3"
            case .fluidSfx4: return "FreeFlow SFX 4"
            }
        }
    ...
    /// Only resumes if FreeFlow was the one that paused it.
    ...
    /// For example: ["fluid voice", "fluid boys"] -> "FreeFlow"
    ...
    enum SpeechModel: String, CaseIterable, Identifiable, Codable {
        ...
        /// Optional badge text for the card (e.g., "FreeFlow Pick")
        var badgeText: String? {
            switch self {
            case .parakeetTDT: return "FreeFlow Pick"
            case .parakeetTDTv2: return "FreeFlow Pick"
