                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                SetupStepView(
                                    ...
                                    description: self.asr.micStatus == .authorized
                                        ? "FreeFlow has access to your microphone"
                                        : "Allow FreeFlow to access your microphone for voice input",
                        ...
                        VStack(spacing: 0) {
                            ...
                            VStack(spacing: 14) {
                                ...
                                if !self.isAccessibilityReady {
                                    Text("Already enabled it? FreeFlow will update when macOS confirms access.")
                                        .font(.system(size: 12, weight: .medium))
                                        .foregroundStyle(Color.white.opacity(0.42))
                                        .padding(.top, 2)
                                }
        ...
        VStack(spacing: 0) {
            HStack(spacing: 14) {
                ...
                if self.devices.isEmpty {
                    ...
                    .frame(width: 248)
                    .tint(.white)
                    .accessibilityHint("Moves the selected microphone to first in FreeFlow priority")
                }
            }
            .padding(.horizontal, 18)
            .frame(height: 62)
