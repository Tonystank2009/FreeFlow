...
final nonisolated class FileLogger: @unchecked Sendable {
    ...
    private init() {
        ...
        self.logDirectory = baseDirectory.appendingPathComponent("Logs/FreeFlow", isDirectory: true)
        self.logFileURL = self.logDirectory.appendingPathComponent("FreeFlow.log", isDirectory: false)
        self.backupLogURL = self.logDirectory.appendingPathComponent("FreeFlow.log.1", isDirectory: false)
